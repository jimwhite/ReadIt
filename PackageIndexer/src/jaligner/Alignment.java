...
public final class Alignment {
	 ...
	 * Gap character
	 */
	public static final Token GAP = new Token("-", 0, 0, "GAP");
	 ...
	 * Scoring matrix
	 */
	private Comparator<Token> matrix;
	 ...
	 */
	public Comparator<Token> getMatrix() {
		return matrix;
	}
	 ...
	 *            The matrix to set.
	 */
	public void setMatrix(Comparator<Token> matrix) {
		this.matrix = matrix;
	}
	 ...
	 */
	public void setSequence1(Token[] sequence1) {
	 ...
	 */
	public void setSequence2(Token[] sequence2) {
	...
	public String getSummary() {
		...
		buffer.append(Commons.getLineSeparator());
//if (matrix != null) 		buffer.append("Matrix: "
//				+ (matrix.getId() == null ? "" : matrix.getId()));
	...
	public float calculateScore() {
        ...
        Token c1, c2; // the next character
		for (int i = start; i <= end; i++) {
			...
			// the next characters in boths sequences are not gaps
				...
				calcScore += matrix.compare(c1, c2);
				previous1wasGap = false;
				previous2wasGap = false;
			}
		}
